      ...
      <section className="p-8">
        ...
        <div className="text-base leading-relaxed w-[90%]">
          ...
          <p className="mt-2">
            ...
            <span className="text-neon font-bold">
              AI Engineer @ Neurofin AI
            </span>
            , specializing in LLM fine-tuning and system optimization. While I
            am currently exploring machine intelligence, my foundation is
          ...
          <p className="mt-2">
            ...
            <span className="text-neon font-bold"> Nokia</span>. I bridge the
            gap between robust web architecture and adaptive machine
            intelligence.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4 mt-6 text-sm">
          <div className="flex items-center gap-3 font-medium">
            <Image src="/images/neurofin.svg" alt="Neurofin AI" width={36} height={36} />
            <a href="https://neurofin.ai/">Neurofin AI</a>
          </div>
          <div className="w-6 h-0.5 -rotate-[70deg] bg-neon"></div>
          <div className="flex items-center gap-3 font-medium">
            <Image src="/images/imanage.svg" alt="iManage" width={36} height={36} />
            <a href="https://imanage.com/">iManage <span className="text-gray-600">(past)</span></a>
          </div>
          <div className="w-6 h-0.5 -rotate-[70deg] bg-neon"></div>
          <div className="flex items-center gap-3 font-medium">
            <Image src="/images/nokia.svg" alt="Nokia" width={36} height={36} />
            <a href="https://nokia.com/">Nokia <span className="text-gray-600">(past)</span></a>
          </div>
        </div>
      </section>
    </div>
